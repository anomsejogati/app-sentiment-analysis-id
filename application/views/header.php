<div class="navbar navbar-expand pr-0 navbar-light border-bottom-2"
    ...
    <span class="d-none d-md-flex align-items-center mr-16pt">
        <small class="flex d-flex flex-column">
            <strong class="navbar-text-100">Halo, <?= $users['username'] ?></strong>
            <span class="navbar-text-50">Anda sedang menggunakan Aplikasi Analisa Sentimen v.1.0</span>
        </small>
    </span>                    
            ...
            <a href="#"
                ...
                <span class="avatar avatar-sm mr-8pt2">
                    ...
                    <span class="avatar-title rounded-circle">
                        <img src="<?= base_url() ?>assets/public/images/avatar/administrator.png"
                                width="50"
                                alt="avatar"
