<script src="<?= base_url('dist/js/text-preprocessing.js') ?>"></script>
    ...
    <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
            ...
            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                <h2 class="mb-0">Text Preprocessing</h2>

                <ol class="breadcrumb p-0 m-0">
                    <li class="breadcrumb-item"><a href="<?= site_url('') ?>">Home</a></li>
                    <li class="breadcrumb-item active">Text Preprocessing</li>
        ...
        <div class="col-lg-12 d-flex align-items-center">
            <div class="flex"
                ...
                <div class="card dashboard-area-tabs p-relative o-hidden mb-0">
                        ...
                        <div class="row no-gutters"
                            ...
                            <div class="col-auto">
                                <a href="#tab_1"
                                    ...
                                    <span class="flex d-flex flex-column">
                                        <strong class="card-title">Case Folding</strong>
                                        <small class="card-subtitle text-50">Text Preprocessing</small>
                                    </span>
                                </a>
                            </div>
                            <div class="col-auto border-left border-right">
                                <a href="#tab_2"
                                    ...
                                    <span class="flex d-flex flex-column">
                                        <strong class="card-title">Tokenization</strong>
                                        <small class="card-subtitle text-50">Text Preprocessing</small>
                                    </span>
                                </a>
                            </div>
                            <div class="col-auto border-left border-right">
                                <a href="#tab_3"
                                    ...
                                    <span class="flex d-flex flex-column">
                                        <strong class="card-title">Filtering</strong>
                                        <small class="card-subtitle text-50">Text Preprocessing</small>
                                    </span>
                                </a>
                            </div>
                    ...
                    <div class="card-body tab-content table-preprocessing">
                        
                        <?php 
                            $this->load->view('app/text-preprocessing/data'); 
                        ?>
