            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <button type="button" class="btn btn-primary btn-rounded mr-2 saveBtn" style="width: 150px"><i class="batch-icon-stiffy icon--left"></i>Simpan</button>
                    </div>
